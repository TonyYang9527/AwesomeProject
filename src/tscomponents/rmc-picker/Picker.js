...
class Picker extends React.Component {
    ...
    render() {
        ...
        const map = (item) => {
            ...
            return (<div style={Object.assign(Object.assign({}, itemStyle), style)} className={`${selectedValue === value ? selectedItemClassName : itemClassName} ${className}`} key={value}>
        ...
        return (<div className={classNames(pickerCls)} ref={el => this.rootRef = el} style={this.props.style}>
