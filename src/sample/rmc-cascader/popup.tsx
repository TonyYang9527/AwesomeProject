...
import PopupCascader from '../../tscomponents/rmc-cascader/Popup';
import globalData from './data';
import arrayTreeFilter from 'array-tree-filter';
import PopupStyles from '../../tscomponents/rmc-cascader/PopupStyles';
import Cascader from '../../tscomponents/rmc-cascader/Cascader';
...
export class CascaderPopupPickerDemo extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
