...
const getModal = (props, visible, { getContent, hide, onDismiss, onOk }) => {
    ...
    return (<Modal prefixCls={`${prefixCls}`} className={props.className || ''} visible={true} closable={false} transitionName={props.transitionName || props.popupTransitionName} maskTransitionName={props.maskTransitionName} onClose={hide} style={props.style}>
      <div>
